...
class InformationDatabase {
  ...
  final String ID = "id";
  final String SO_BI_TRU = "so_bi_tru";
  final String SO_TRU = "so_tru";
  final String KET_QUA = "ket_qua";
 ...
 */
  ...
  Future<List<Information>> fetchAll() async {
    ...
    if (res.isNotEmpty) {
      var informations = res.map((map) => Information.fromJson(map)).toList();
      return informations;
    }
    return [];
  }

  Future<int> updateWord(Information information) async {
    var client = await db;
