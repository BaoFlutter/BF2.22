...
import 'package:state_base/views/local_information_screen.dart';
            ...
            children: [
              ...
              ElevatedButton(
                  onPressed: (){
                    ...
                    saveInformationToSharedPreferences(averageMark: averageMark, adjustment: adjustment);
                  },
              ...
              TextButton(
                  onPressed: (){
                    var route = MaterialPageRoute(builder: (context) => LocalInformationScreen());
                    Navigator.push(context, route);
                  },
                  child: Text("Show Information From Local Storage"))
...
// SharedPreference : là local storage :  ( key, value )
  // Lưu giá trị vào local Storage
   saveInformationToSharedPreferences({ required String averageMark , required String adjustment}) async {
